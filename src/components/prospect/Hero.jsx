  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            'url(https://images.unsplash.com/photo-1499793983690-e29da59ef1c2?w=1600&auto=format&fit=crop&q=80)'
        }}
      />
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <p className="text-xl text-white/75 max-w-2xl mx-auto mb-10 leading-relaxed">
          {REALTOR.name} · {REALTOR.company} — Serving Brunswick, St. Simons Island, Jekyll Island & Sea Island. Expert guidance from search to close.
        </p>
